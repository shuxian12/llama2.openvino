...
if model_path.exists():
    ov_model = OVModelForCausalLM.from_pretrained(model_path, device=args.device)
else:
    ov_model = OVModelForCausalLM.from_pretrained(args.model_id, device=args.device, from_transformers=True)
...
generate_ids = ov_model.generate(inputs.input_ids, max_length=args.max_sequence_length)
